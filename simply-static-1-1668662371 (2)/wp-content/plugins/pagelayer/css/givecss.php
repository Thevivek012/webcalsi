...
@font-face {
  font-family: 'pagelayer';
  src:  url('/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/fonts/pagelayer.eot?p8l7ih');
  src:  url('/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/fonts/pagelayer.eot?p8l7ih#iefix') format('embedded-opentype'),
    url('/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/fonts/pagelayer.ttf?p8l7ih') format('truetype'),
    url('/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/fonts/pagelayer.woff?p8l7ih') format('woff'),
    url('/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/fonts/pagelayer.svg?p8l7ih#pagelayer') format('svg');
  font-weight: normal;
  font-style: normal;
  font-display: block;
}
...
.pagelayer-splash{
background-image:url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/splash.png);
height:30px;
...
background:url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/space.png);
background-repeat:repeat;
}

.pagelayer-anchor{
background-image:url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/anchor.png);
height:30px;
background-position: center center;
background-repeat: no-repeat;
background-size: cover;
...
.nivo-lightbox-theme-default .nivo-lightbox-content.nivo-lightbox-loading { background: url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/nivo-icons/loading.gif) no-repeat 50% 50%; }
...
.nivo-lightbox-theme-default .nivo-lightbox-prev { 
	background-image: url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/nivo-icons/prev.png); 
	border-radius: 0 3px 3px 0;
}
.nivo-lightbox-theme-default .nivo-lightbox-next { 
	background-image: url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/nivo-icons/next.png); 
	border-radius: 3px 0 0 3px;
}

.nivo-lightbox-theme-default .nivo-lightbox-close {
	display: block;
	background: url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/nivo-icons/close.png) no-repeat;
	width: 48px;
	height: 48px;
	text-indent: -9999px;
	padding: 5px;
...
@media (-webkit-min-device-pixel-ratio: 1.3),
	...
	.nivo-lightbox-theme-default .nivo-lightbox-content.nivo-lightbox-loading { 
		background-image: url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/nivo-icons/loading@2x.gif); 
		-webkit-background-size: 32px 32px; 
		        background-size: 32px 32px;
	}
	.nivo-lightbox-theme-default .nivo-lightbox-prev { 
		background-image: url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/nivo-icons/prev@2x.png); 
		-webkit-background-size: 48px 48px; 
		        background-size: 48px 48px;
	}
	.nivo-lightbox-theme-default .nivo-lightbox-next { 
		background-image: url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/nivo-icons/next@2x.png); 
		-webkit-background-size: 48px 48px; 
		        background-size: 48px 48px;
	}
	.nivo-lightbox-theme-default .nivo-lightbox-close { 
		background-image: url(/www.webcalsi.unaux.com/path/wp-content/plugins/pagelayer/images/nivo-icons/close@2x.png); 
